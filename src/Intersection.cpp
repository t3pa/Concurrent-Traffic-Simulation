...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    {
      std::cout << "Intersection #" << getID() << ": Vehicle #" << vehicle->getID() << " is waiting on green." << std::endl;
      _trafficLight->waitForGreen();
      std::cout << "Intersection #" << getID() << ": Vehicle #" << vehicle->getID() << " received green." << std::endl;
    }
    lck.unlock();
}
